...
class DataInitializer {
    ...
    companion object {
        ...
        private val FEEDBACK_SEEDS = listOf(
            ...
            SeedFeedback(
                email = "le.gia43@vocafy.local",
                rating = 5,
                title = "Mượt hơn mình tưởng",
                content = "Mình tưởng app học từ vựng sẽ khô lắm mà dùng lại khá cuốn. Lướt một hồi hết buổi luôn.",
                createdAt = LocalDateTime.of(2026, 4, 1, 9, 5, 0),
            ),
            SeedFeedback(
                email = "lechau22x@vocafy.local",
                rating = 4,
                title = "Ổn nha",
                content = "Học ổn nha, nhất là mấy lúc tranh thủ ngồi chờ. Nếu load nhanh hơn chút nữa thì đẹp.",
                createdAt = LocalDateTime.of(2026, 4, 1, 10, 18, 0),
            ),
            SeedFeedback(
                email = "duc.dung.18@vocafy.local",
                rating = 5,
                title = "Có động lực học hơn",
                content = "Trước mình toàn mở app rồi để đó, mà cái này dùng thấy có động lực học hơn thiệt. Gọn với dễ vào bài.",
                createdAt = LocalDateTime.of(2026, 4, 1, 11, 42, 0),
            ),
            SeedFeedback(
                email = "quoc.giang.39@vocafy.local",
                rating = 4,
                title = "Thiếu chút nữa là tròn",
                content = "Tổng thể ổn áp. Mình chỉ mong phần ôn lại từ cũ linh hoạt hơn xíu là gần như không có gì để chê.",
                createdAt = LocalDateTime.of(2026, 4, 1, 13, 7, 0),
            ),
            SeedFeedback(
                email = "khanh_le25@vocafy.local",
                rating = 5,
                title = "Học ít mà vẫn vào",
                content = "Mỗi ngày học ít ít mà vẫn thấy vô đầu. Kiểu không cần cố quá mà vẫn có tiến triển.",
                createdAt = LocalDateTime.of(2026, 4, 1, 14, 26, 0),
            ),
            SeedFeedback(
                email = "thu.linh.54@vocafy.local",
                rating = 4,
                title = "Nhìn dễ chịu",
                content = "Màu với cách sắp xếp dễ chịu thật. Mở ra không bị cảm giác ngợp như vài app khác.",
                createdAt = LocalDateTime.of(2026, 4, 1, 16, 15, 0),
            ),
            SeedFeedback(
                email = "pminh.an90@vocafy.local",
                rating = 5,
                title = "Khá dính",
                content = "Định học vài set thôi mà nhiều lúc học lố luôn. App này có gì đó làm mình không muốn thoát vội.",
                createdAt = LocalDateTime.of(2026, 4, 1, 18, 4, 0),
            ),
            SeedFeedback(
                email = "phambinh55x@vocafy.local",
                rating = 4,
                title = "Nội dung ổn",
                content = "Nội dung ổn, đủ để học hằng ngày. Có thêm ít bài theo tình huống đi làm nữa thì càng hay.",
                createdAt = LocalDateTime.of(2026, 4, 1, 20, 33, 0),
            ),
            SeedFeedback(
                email = "pham.chau8119@vocafy.local",
                rating = 5,
                title = "Đỡ buồn ngủ hơn",
                content = "Mình hay học tối nên dễ buồn ngủ, mà app này chia nhịp học vừa nên đỡ gục ngang hơn thật.",
                createdAt = LocalDateTime.of(2026, 4, 2, 7, 50, 0),
            ),
            SeedFeedback(
                email = "pham.duc68@vocafy.local",
                rating = 4,
                title = "Dùng ổn trong lúc bận",
                content = "Ai bận bận như mình chắc sẽ thích kiểu này. Mở ra học một lúc ngắn vẫn thấy được việc.",
                createdAt = LocalDateTime.of(2026, 4, 2, 9, 38, 0),
            ),
            SeedFeedback(
                email = "pham.giang8990@vocafy.local",
                rating = 5,
                title = "Không bị nhồi quá tay",
                content = "Mình thích nhất là app không cố nhồi quá nhiều một lúc. Học xong vẫn muốn quay lại học tiếp.",
                createdAt = LocalDateTime.of(2026, 4, 2, 11, 16, 0),
            ),
            SeedFeedback(
                email = "pham.bao29@vocafy.local",
                rating = 4,
                title = "Cũng đáng để dùng lâu",
                content = "Dùng vài hôm thấy khá ổn chứ không phải kiểu mới đầu vui rồi chán nhanh. Hy vọng giữ form này lâu dài.",
                createdAt = LocalDateTime.of(2026, 4, 2, 13, 2, 0),
            ),
            SeedFeedback(
                email = "ngoc.khanh.40@vocafy.local",
                rating = 5,
                title = "Có cảm giác được dẫn học",
                content = "Mình thích kiểu app này dẫn từng bước nên đỡ phải nghĩ nhiều. Chỉ việc mở lên rồi học thôi.",
                createdAt = LocalDateTime.of(2026, 4, 2, 15, 27, 0),
            ),
            SeedFeedback(
                email = "pthu.linh46@vocafy.local",
                rating = 4,
                title = "Khá hợp người mới",
                content = "Mình mới học lại nên cần thứ gì đó dễ bắt đầu. App này khá hợp kiểu đó, không làm mình nản từ đầu.",
                createdAt = LocalDateTime.of(2026, 4, 2, 17, 45, 0),
            ),
            SeedFeedback(
                email = "pham.anh17@vocafy.local",
                rating = 5,
                title = "Nhìn nhỏ mà có võ",
                content = "Giao diện nhìn gọn gàng thôi mà học vào mới thấy có võ. Kiểu càng học càng thấy hợp.",
                createdAt = LocalDateTime.of(2026, 4, 2, 20, 9, 0),
            ),
            SeedFeedback(
                email = "ptuan.quynh30@vocafy.local",
                rating = 4,
                title = "Được cái không rườm rà",
                content = "Mình thích kiểu ít nút ít rối như này. Cần gì học là vào học luôn, không phải đi tìm lung tung.",
                createdAt = LocalDateTime.of(2026, 4, 2, 21, 31, 0),
            ),
        )
    }
